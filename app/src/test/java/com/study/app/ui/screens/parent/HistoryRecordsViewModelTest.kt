...
class HistoryRecordsViewModelTest {
    ...
    private lateinit var viewModel: HistoryRecordsViewModel
    ...
    fun initial_state_has_empty_records_list() = runTest {
        ...
        viewModel = HistoryRecordsViewModel(practiceRepository, subjectRepository, gradeRepository)
    ...
    @Test
    fun accuracy_rate_calculated_correctly() = runTest {
    ...
    @Test
    fun accuracy_rate_returns_zero_for_zero_questions() = runTest {
        val record = PracticeRecord(
            id = 1,
            subjectId = 1,
            gradeId = 1,
